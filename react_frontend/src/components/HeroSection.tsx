        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4">
            <nav className="flex flex-col space-y-2">
              <a href="#home" className="text-white hover:text-indigo-300 py-2">
                Home
              </a>
              <a href="#academics" className="text-white hover:text-indigo-300 py-2">
                Academics
              </a>
              <a href="#activities" className="text-white hover:text-indigo-300 py-2">
                Activities
              </a>
              <a href="#about" className="text-white hover:text-indigo-300 py-2">
                About
              </a>
              <a href="#contact" className="text-white hover:text-indigo-300 py-2">
                Contact
              </a>
              <Link to="/portals">
