  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple via-purple-700 to-purple relative overflow-hidden">
      ...
      <div className="relative flex justify-between items-center p-6 md:p-8">
        <button className="bg-white text-purple-800 px-4 py-2 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg">
          HELP
        </button>

        <Link to="/">
          <button className="bg-white text-purple-800 px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-gray-100 hover:scale-105 transform transition-all duration-300 flex items-center gap-2">
            <ArrowLeft size={20} />
            Back to Home
          </button>
        </Link>
